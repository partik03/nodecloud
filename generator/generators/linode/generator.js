    ...
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    functionsArray = [];
                    return [4 /*yield*/, sdkFiles.map(function (file) { return __awaiter(_this, void 0, void 0, function () {
                            var _this = this;
                            return __generator(this, function (_a) {
                                parser_1.getAST(file).then(function (result) { return __awaiter(_this, void 0, void 0, function () {
                                    ...
                                    return __generator(this, function (_a) {
                                        sdkAst = result;
                                        try {
                                            functions = extractSDKData(sdkAst, serviceClass);
                                            functions.map(function (method, index) {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    files = Array.from(new Set(methods_1.map(function (method) { return method.fileName; })));
